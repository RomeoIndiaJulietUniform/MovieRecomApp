...
CORS(application, origins=["http://movierecomapi-env.eba-as2s4bmc.ap-southeast-1.elasticbeanstalk.com", "https://movierecomapi-env.eba-as2s4bmc.ap-southeast-1.elasticbeanstalk.com"])
...
@application.route('/api/similarity/<name>')
@cross_origin()
...
@application.route('/api/similar_names/<partial_name>')
@cross_origin()
